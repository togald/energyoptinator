...
def offgrid_house_sim():
    ...
    eo.Grid('Heat', s)
    eo.Grid('Gasoline', s, 'kW')
    eo.Grid('Wood pellets', s, 'kW')
    ...
    eo.CHPboiler('Furnace', s, 'Wood pellets', 'Heat', 'Electricity', heatreg, heatsig, thermalRatedPower=0.5, electricityRatedPower=0.1, fuelUse=0.65)
    elreg = eo.OnoffRegulator(0.3, 0.85, 0)
