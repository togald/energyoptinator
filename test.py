...
def offgrid_house_sim():
    ...
    eo.TimevariantSink('Hot water', s, 'Heat', se.hourly_to_6min(se.daily_to_hourly(se.hemsol_tvv_smoothed(tvv))))
    eo.TimevariantSink('Space heating', s, 'Heat', se.hourly_to_6min(se.daily_to_hourly(se.hemsol_varme_smoothed(varme))))
    ...
    eo.CHPboiler('Furnace', s, 'Wood pellets', 'Heat', 'Electricity', heatreg, heatsig, thermalRatedPower=.6, electricityRatedPower=0.0, fuelUse=0.65)
